...
@interface SDCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate, SDCycleScrollViewDelegate>
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if ([self.delegate respondsToSelector:@selector(cycleScrollView:didShowItemAtIndex:)]) {
        [self.delegate cycleScrollView:self didShowItemAtIndex:indexOnPageControl];
    }
